...
//       });
//       searchOutput += '</ul>';
//       if(searchField!="") $('#update').html(searchOutput); //output result to the update div
//       else $('#update').html('');
//     });
// });

  $(function() {
    var sectorName = sector(biographical);
    var industryName = industry(biographical, sectorName);
    company(biographical, technical, industryName);
  });
/*
*
*
...
*
*/
//$.get('http://valueinvestingtool.com/practice-linda/biographical.json', function(data) {
//$.get('/Users/lindapark/Desktop/value_investing_tool/public/json_files/biographical.json', function(data) {
  ...
  *
  */
  //$.getJSON('http://valueinvestingtool.com/practice-linda/biographical.json', function(data) {
    ...
    $('a.aIndustry').click( function(e) {
      ...
      */
      //$.getJSON('http://valueinvestingtool.com/practice-linda/biographical.json', function(data) {
        function company(biographicaljson, technicaljson, industry) {
        ...
        for (var i = 0; i < biographical.length; i++) {
          if (industry == biographical[i]['industry'] && !(nameOfIndustry in matchingIndustries)) { // if industry names match and not already in a list of cells
        ...
        *
        *
        *** GET REQUEST ON TECHNICAL.JSON
        *
        *
        */
        //$.getJSON('http://valueinvestingtool.com/practice-linda/technical.json', function(data) {
